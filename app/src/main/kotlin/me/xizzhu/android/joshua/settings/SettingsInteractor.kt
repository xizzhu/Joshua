...
class SettingsInteractor(private val settingsManager: SettingsManager,
    ...
    private val backupPrepared: BroadcastChannel<ViewData<String>> = ConflatedBroadcastChannel()
    ...
    fun backupPrepared(): Flow<ViewData<String>> = backupPrepared.asFlow()
    ...
    fun prepareBackupData() {
        coroutineScope.launch {
            try {
                ...
                backupPrepared.offer(ViewData.error("", e))
            }
        }
    }

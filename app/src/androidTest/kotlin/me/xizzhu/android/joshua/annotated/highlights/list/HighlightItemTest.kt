...
class HighlightItemTest : BaseUnitTest() {
    ...
    fun testTextForDisplaySortByDate() {
        ...
        val actual = HighlightItem(MockContents.kjvVerses[0].verseIndex, MockContents.kjvBookNames[0],
    ...
    fun testTextForDisplaySortByBook() {
        ...
        val actual = HighlightItem(MockContents.kjvVerses[0].verseIndex, MockContents.kjvBookNames[0],
                MockContents.kjvBookShortNames[0], MockContents.kjvVerses[0].text.text, Highlight.COLOR_NONE, Constants.SORT_BY_BOOK, {})
                .textForDisplay.toString()
        assertEquals(expected, actual)
    }
}
